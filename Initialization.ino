...
void initSD(){
  ...
  String FHeader = "Flight Time, Minutes, Matser Clock Minutes, Lat, Long, Altitude (ft), Date, Hour:Min:Sec, Satellites, Fix, IntTemp (C), ExtTemp (C), BatTemp (C), Pressure (PSI), Pressure (ATM),";
