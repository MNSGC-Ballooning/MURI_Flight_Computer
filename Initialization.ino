...
void initOLED(MicroOLED& named){                                        //Initializes the OLED Screen
  ...
  named.print("PUMPER NICKEL   YEET");
  named.display();
  delay(2000);
}
...
void initSD(){
  ...
  FHeader += "Battery Heater Status, Sensor Heater Status, Control Altitude, Vent Connect, Vent Status, Resistor Status, Cut Reason, Ascent Rate, Average Ascent Rate, System State,";
